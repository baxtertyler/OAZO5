...
(module my-mod1 (submod ".." sim-OAZO5)
  ...
  {let [pow <- {anon {self base power} :
                     {if {<= power 0}
                         then 1
                         else {* base {self self base {- power 1}}}}}]
    {pow pow 5 2}}
  ...
  {let [sin <- {anon {self fact pow x n} :
                     {if {<= 0 n}
                         then 1
                         else {}}}]
    {sin sin fact pow 1 30}}
